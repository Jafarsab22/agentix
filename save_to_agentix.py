...
def _make_norm_key(product: str, brand_type: str, model_name: str, badges: List[str], price_value, price_currency: str, est_model: str) -> str:
...
def persist_results_if_qualify(
    ...
    norm_key = _make_norm_key(product, brand_type, model_name, badges, price_value, price_currency, est_model)
    ...
    run_doc = {
        ...
        'n_iterations': n_iterations,
        'badges_csv': ','.join(sorted([b for b in badges if str(b).strip()])),
